...
$sql= "SELECT sacc_no , username , branch_no , racc_no , amount , phno , date FROM moneytrans WHERE sacc_no = '$acc_no'";
...
<tr>
            <th class='hed' colspan='8'>OBI  MONEY TRANSFER  INFORMATION</th>
              </tr>
            <tr>
            <th>SENDER ACC_NO</th>
            <th>SENDER NAME</th>
            <th>BRANCH_NO</th>
            <th>RECEIVER ACC_NO</th>
            <th>BALANCE</th>
            <th>PHNO</th>
            <th>DATE</th>
          </tr>";
          while($row = mysqli_fetch_assoc($result)){
             echo "<tr>"; 
              ...
              echo "<td>" .  $row["sacc_no"]  . "</td>";
              echo "<td>" .  $row["username"]   . "</td>";
              echo "<td>" .  $row["branch_no"]  . "</td>";
              echo "<td>" .  $row["racc_no"] . "</td>";
...
echo "<br><br><br>";
  echo "no transaction taken place or check the account number";
}
?>
</body>
</html>
